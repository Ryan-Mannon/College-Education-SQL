...
CREATE TABLE IF NOT EXISTS tuition_info (
    ...
    in_state_total DECIMAL(10,2),
    out_of_state_tuition DECIMAL(10,2),
    out_of_state_total DECIMAL(10,2),
...
CREATE TABLE IF NOT EXISTS diversity_stats (
    ...
    women DECIMAL(5,2),
    americanIndian_alaskaNative DECIMAL(5,2),
    asian DECIMAL (5,2),
    black DECIMAL (5,2),
    hispanic DECIMAL (5,2),
    hawaiianNative_pacificIslander DECIMAL (5,2),
    white DECIMAL (5,2),
    twoPlus DECIMAL (5,2),
    unknown_race DECIMAL (5,2),
    nonResident_foreign DECIMAL (5,2),
    total_minority DECIMAL (5,2),
    FOREIGN KEY (college_id) REFERENCES colleges(college_id)
);
...
CREATE TABLE IF NOT EXISTS salary_potential (
    college_id INT PRIMARY KEY,
    early_career_pay DECIMAL(10,2),
    mid_career_pay DECIMAL(10,2),
    stem_percent DECIMAL(5,2),
    FOREIGN KEY (college_id) REFERENCES colleges(college_id)
);
